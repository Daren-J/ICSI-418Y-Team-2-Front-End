        ...
        <div className="ProfilePictureDiv">
          ...
          <div className="InputFormProfile">
            ...
            <div className="UsernameValueProfile">
              <h2 style={{ color: "#ffa62b", marginTop: "5px" }}>Sample 7</h2>
            </div>
            ...
            <div className="FirstNameValueProfile">
              <h2 style={{ color: "#ffa62b", marginTop: "5px" }}>FName</h2>
            </div>
            ...
            <div className="LastNameValueProfile">
              <h2 style={{ color: "#ffa62b", marginTop: "5px" }}>LName</h2>
            </div>
          ...
          <div className="ButtonsProfileDiv">
            <ButtonGroup spacing={8}>
              <Button leftIcon="email" color="black" backgroundColor="#82c0cc" variantColor="white" variant="solid">
                Change Email
              </Button>
              <Button leftIcon={MdBuild} color="black" backgroundColor="#82c0cc" variantColor="white" variant="solid">
                Change Password
              </Button>
              <Button leftIcon={MdBuild} color="black" backgroundColor="#82c0cc" variantColor="white" variant="solid">
                Change Names
